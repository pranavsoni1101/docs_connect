...
export async function createUser(req, res, {docname, mobile, email, password, qualification, specialization}) {
  ...
  if(req.method === "POST") {
    ...
    console.log("user result saved from create new user: ", result);
  }
